-- ============================================================
--  PetCare — Script para Railway (sin CREATE DATABASE / USE)
--  Motor: MySQL 8.x
...
CREATE TABLE IF NOT EXISTS recomendaciones_cuidado (
  id          INT           NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS mascotas_cuidadores (
...
CREATE TABLE IF NOT EXISTS recursos_veterinarios (
  id          INT           NOT NULL AUTO_INCREMENT,
  nombre      VARCHAR(200)  NOT NULL,
  descripcion TEXT          NULL,
  tipo        ENUM('clinica','guia','asociacion','directorio') NOT NULL,
  url_externo VARCHAR(255)  NULL,
  PRIMARY KEY (id)
);
...
('Manual de primeros auxilios', 'Referencia rápida de atención inicial (PetMD).',   'guia',       'https://www.petmd.com/dog/emergency'),
('Directorio de laboratorios',  'Puntos de apoyo para exámenes y procedimientos.',  'directorio', 'https://www.petcare.com/laboratorios');
